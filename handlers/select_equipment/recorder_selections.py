...
@dp.message_handler(text='Регистратор', state=Selections.q_1)
...
@dp.callback_query_handler(choice_reg_callback.filter(make='show'), state=RegSelections.q_4)
...
@dp.callback_query_handler(choice_reg_callback.filter(make='choice'), state=RegSelections.q_4)
