...
INSERT INTO invasion (name, short_name, type_sensor, type, price, installation, photo) VALUES
    ...
    ('MotionProtect Plus', 'Датчик движения', 'm', 'Датчик движения', '4470', 'Внутрений', 'https://ajax.systems/wp-content/themes/ajax/assets/images/template/catalog/products/MotionProtect_white@1x.png'),
    ...
    ('DoorProtect', 'Датчик открытия', 'o', 'Датчик открытия', '1680', 'Внутрений', 'https://ajax.systems/wp-content/themes/ajax/assets/images/template/catalog/products/DoorProtect_black@1x.png'),
